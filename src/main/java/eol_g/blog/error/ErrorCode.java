...
public enum ErrorCode {
    ...
    POST_NOT_FOUND(400,"P002", "포스트를 찾을 수 없습니다."),
    POST_NOT_EXIST(404, "P003", "존재하지 않는 포스트입니다."),
    POST_NOT_TEMP(400, "P004", "임시저장된 포스트가 아닙니다."),
    CATEGORY_NOT_FOUND(400, "C001", "카테고리를 찾을 수 없습니다."),
    CATEGORY_NOT_EXIST(404, "C002", "존재하지 않는 카테고리입니다."),
